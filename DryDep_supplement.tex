...
\subsection*{S.6 }
\subsubsection*{S.6.1 Normed zonal average ozone dry deposition velocity}
\appendixfigures
\begin{center}
  \includegraphics[height=0.4\textheight, clip, trim={0.7cm 0.7cm 0.7cm 0.55cm}]{pictures/final-norm_total_ozone_drydepvelo}
\end{center}

\subsubsection*{S.6.2 Average ozone dry deposition velocity seperated by land surface type (southern hemisphere)}
\appendixfigures
\begin{center}
