...
\appendixfigures
\begin{center}
  \includegraphics[height=0.4\textheight, clip, trim={0.75cm 0.75cm 0.75cm 0.75cm}]{pictures/PAR_as_is.png}
\end{center}
\subsubsection*{S.5.2 Partly de-accumulated}
\appendixfigures
\begin{center}
  \includegraphics[height=0.4\textheight, clip, trim={0.75cm 0.75cm 0.75cm 0.75cm}]{pictures/PAR_partly_deaccumulated.png}
\end{center}
...
\appendixfigures
\begin{center}
  \includegraphics[height=0.4\textheight, clip, trim={0.75cm 0.75cm 0.75cm 0.75cm}]{pictures/final-total_ozone_drydepvelo_monthly_pft_sh}
\end{center}
\end{document}
