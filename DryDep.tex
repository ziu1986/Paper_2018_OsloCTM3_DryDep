...
We follow the Convention on Long-Range Transboundary Air Pollution (CLRTAP) implemented in the European Monitoring and Evaluation Programme (EMEP) MSC-W model \citep{ACP:Simpson2012,ICP:MappingManual2017}. It is a more physical approach compared to \citet{AE:Wesely1989, JGR:Hough1991}. The scheme is used for the gaseous species \chem{O_3}, \chem{H_2O_2}, \chem{NO_2}, \chem{PAN}, \chem{SO_2}, \chem{NH_3}, \chem{HCHO}, and \chem{CH_3CHO}. Since \chem{CO} has a very small uptake and is not included in the EMEP scheme, the old OsloCTM2 parameterization is kept. In adition to the gaseous species, some of the aerosol deposition rates have also been modified, namely black carbon (BC) and organic carbon (OC), sulphuric (\chem{SO_4}, \chem{MSA}), and secondary organic aerosols (SOA).
