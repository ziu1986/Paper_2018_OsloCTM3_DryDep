...
\begin{table*}[t]
  ...
  \begin{tabular}{lccccccccc}
    ...
    mOSaic            &   x & x & x                &   &  x & x  & 2005 \\
    mOSaic\_offLight  &   x & 1 & x                &   &  x & x  & 2005 \\
    mOSaic\_offPhen   &   1 & x & x                &   &  x & x  & 2005 \\
    mOSaic\_SWVL1     &   x & x & SWLV1            &   &  x & x  & 2005 \\
    mOSaic\_ice       &   x & x & x                &   &  x & x; \citet{ACP:Helmig2007}$^\dagger$ & 2005 \\
    mOSaic\_desert    &   x & x & x                &   &  x & x; \citet{AE:Gusten1995}$^*$  & 2005 \\
    mOSaic\_emis2014  &   x & x & x                &   &  x & x  & 2014 \\
    mOSaic\_hough     &   x & x & x                &   &  x & \citet{AE:Wesely1989, JGR:Hough1991}$^\star$  & 2005 \\
    \bottomhline
  \end{tabular}
  \label{tab:simsum}
  \belowtable{$^\dagger\,R^\chem{O_3}_\text{ice/snow}=10000\,\unit{s\,m^{-1}}$; $^*\,R^\chem{O_3}_\text{desert}=800\,\unit{s\,m^{-1}}$; $^\star\,$Supplement~S.7} % Table Footnotes
\end{table*}
%
\begin{figure}[t]
