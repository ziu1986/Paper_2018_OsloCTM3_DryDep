...
\begin{equation}
  R_a = \frac{1}{\kappa u_*}\left[{\ln{\left(\frac{z-d}{z_0}\right)}-\Psi_h\left(\frac{z-d}{L}\right)+\Psi_h\left(\frac{z_0}{L}\right)}\right],
\end{equation}
