...
Resolution and representativeness of site
Come back to the discussion of the multi-model-mean - there seems to be a tendency that the ozone dry deposition is much lower in more advanced, newer models than in the old ones. May also include \citep{AE:Hu2017} in this part of the discussion.
%\subsection{HEADING}
...
\label{sec:conc}
We have presented an update of the dry deposition scheme in the OsloCTM3 from a purely prescribed parameterization based on the works of \citet{AE:Wesely1989,JGR:Hough1991} to a more process oriented parameterization taking the state of the atmosphere into account \citep{ACP:Simpson2012}. In general, this update decreases the annual amount of ozone dry deposition up to $100\,\unit{\%}$ especially over large desert regions and the oceans. Most of this decrease is due to changes in the baseline dry deposition velocities at the order of one magnitude in case of desert and grasslands or the accumulative effect of small changes over the ocean in the southern hemisphere. With respect to available measurements of dry deposition velocities of ozone over desert \citep{AE:Gusten1995} and ocean \citep{JGR:Helmig2012}, the OsloCTM3 may slightly underestimate ozone dry deposition in the former case and overestimate it in the latter. Regarding the vastness of the ocean and the ongoing desertification, it may be worthwhile studying dry deposition in these regimes at a more process-based level (e.g., 2-layer gas exchange with ocean waters). Although ice and snow only amounts to less than $1\,\unit{\%}$ to the global annual ozone dry deposition, a change in dry deposition velocities not only almost doubles the surface ozone concentrations in the high Arctics but also affects surface ozone down to latitudes at about $50\,\unit{^\circ}$. In comparison to multi-model-mean results, we conclude that it is important to use an updated ozone dry deposition to ice and snow \citep{ACP:Helmig2007}. We have extensively studied the parameter space of the stomatal conductance parameterization and found the largest sensitivity of total surface ozone in the tropics. This may indicate that changes in solar radiation due to changes cloud and aerosol may also strongly influence surface ozone in the tropics. In the most extreme test scenario, allowing for an unlimited photosynthesis, the increase in surface ozone amounts to up to $16\,\unit{\%}$ compared to the reference experiment. Switching off the phenology in the tropics only increases ozone there by up to $10\,\unit{\%}$, while the complete switch-off amounts only to a maximum increase of $5\,\unit{\%}$. Total surface ozone increases by about $7.7\,\unit{\%}$ in the northern hemisphere ($(50-75)\,\unit{^\circ N}$) if a greening season based on a $5\,\unit{^\circ C}$-days criteria is used. An important factor in the global ozone budget are also emissions of precursor substances. In a comparison between 2005 and 2014 emissions using the same meteorology, we found a decrease in total surface ozone up to $5\,\unit{\%}$ in the tropics. We also evaluated the model with observed dry deposition velocities at six sites in the northern hemisphere and found that the updated dry deposition scheme performs better than the old one, but is not able to reproduce the measurements at most sites well. This may be due to several reasons. The rather low model resolution in both horizontal and vertical affects the distribution and transport (e.g., long-range, stratosphere--troposphere exchange) as well as the regional production of ozone. Depending on the location of the observation site and its respective representativeness for a larger area ozone dry deposition and ozone concentrations will be over- or underestimated. In addition, a comparison of very few years of measurement to only one specific year of simulation may reflect the year to year variability more than the actual model performance.
For further diagnostics, we shall make dry deposition velocities directly available in the model output.
...
\begin{figure*}[!htbp]
  ...
  \caption{Partitioning of land surface types. (a) CML2 dynamic land surface types in $(0.5\times0.5)\,\unit{^\circ}$ resolution; (b) Zonal distribution of land surface types.}
