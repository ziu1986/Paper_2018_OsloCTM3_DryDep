...
\label{subsec:obs}
In this section, we compare our results to observations. For all comparisons with observations, we use the original resolution of the OsloCTM3 instead of the re-gridded.
...
{\bf Additional zonal data and tropospheric ozone burden from satellites and sondes (\url{http://bodekerscientific.com/})?}
