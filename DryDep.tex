...
\begin{equation}
  ...
  \begin{cases}
    ...
    \text{LAI}\cdot 5/3.5 & \emph{if} \quad \text{\emph{cropland}, 1. part of growing season},\\
    \text{LAI} + 1.5 & \emph{if} \quad \text{\emph{cropland}, 2. part of growing season},\\
