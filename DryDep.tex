...
For \chem{NH_3}, \chem{SO_2}, and \chem{HNO_3}, we follow exactly the treatment as described by \citet{ACP:Simpson2012}. Since the dry deposition velocity for \chem{CO} is very small, we use a fixed value for $v_d^\chem{CO}$ of 0.03\,\unit{m\,s^{-1}}.
